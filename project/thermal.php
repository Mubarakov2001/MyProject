...
<body>
    <header class='header-container'>
        <nav class='header-nav'>
            ...
            <a href='/thermal' class='header-nav-element' style="color: rgb(87, 87, 177);">Тепловые явления</a>
    ...
    <main>
        <h1 class='main-title'>Тепловые явления</h1>
        <?php
            ...
            if ($con == false) {
                ...
                $sql = "SELECT id, name, video, uses FROM data WHERE type='thermal'";
