...
<head>
    ...
    <title>Электрические явления</title>
...
<header class='header-container'>
    <nav class='header-nav'>
        ...
        <a href='electric' class='header-nav-element' style="color: rgb(87, 87, 177);">Электрические явления</a>
...
<main>
    <h1 class='main-title'>Электрические явления</h1>
    <?php
    ...
    if ($con == false) {
        ...
        $sql = "SELECT id, name, video, uses FROM data WHERE type='electric'";
