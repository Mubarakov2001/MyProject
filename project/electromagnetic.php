...
<head>
    ...
    <title>Электромагнитные явления</title>
...
<header class='header-container'>
    <nav class='header-nav'>
        ...
        <a href='electromagnetic' class='header-nav-element' style="color: rgb(87, 87, 177);">Электромагнитные явления</a>
        <a href='light' class='header-nav-element'>Световые явления</a>
        <a href='how' class='header-nav-element'>Как же так?</a>
    </nav>
</header>
<main>
    <h1 class='main-title'>Электромагнитные явления</h1>
    <?php
    ...
    if ($con == false) {
        ...
        $sql = "SELECT id, name, video, uses FROM data WHERE type='electromagnetic'";
